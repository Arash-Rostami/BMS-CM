...
enum Source: string implements HasColor, HasIcon, HasLabel
{
    ...
    {
        return match ($this) {
            self::PR => __('resources/proformaInvoice/strings.source.tooltip.pr'),
            self::RO => __('resources/proformaInvoice/strings.source.tooltip.ro'),
            self::PO => __('resources/proformaInvoice/strings.source.tooltip.po'),
            default => null,
        };
    }
}
