...
trait Form
{
    ...
    public static function getPurchaseRequestsField(): Select
    {
        return Select::make('purchaseRequests')
            ...
            ->preload()
            ->searchable()
//            ->rules(['nullable', 'exists:purchase_requests,id'])
//            ->validationMessages([
...
//            ])
    ...
    public static function getTotalCfrAmountField(): TextInput
    {
        return TextInput::make('total_cfr_amount')
            ->label(__('resources/proformaInvoice/strings.form.total_cfr_amount'))
            ->readOnly()
            ->prefix('💰')
            ->validationAttribute(__('resources/proformaInvoice/strings.form.total_cfr_amount'));
    }
    ...
    public static function getItemProductIdField(): Select
    {
        return Select::make('product_id')
            ...
            ->getOptionLabelFromRecordUsing(function (Model $record): string {
                ...
                return $record->english_name ?? $record->code ?? $record->id ?? '';
            })
