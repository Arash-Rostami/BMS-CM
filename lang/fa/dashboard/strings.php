...
return [
    ...
    'shortcuts_pinned' => 'میانبر پین شده است',
    'no_shortcuts' => 'هیچ میانبری تنظیم نشده است',
    'no_shortcuts_hint' => 'ماژول‌های پرکاربرد خود را اینجا پین کنید تا به سرعت در دسترس باشند.',
];
