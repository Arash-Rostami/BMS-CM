...
return [
    ...
    'form' => [
        ...
        'helper_container_no' => 'تعداد کانتینرهای این محموله (۱–۳۰).',
        ...
        'validation' => [
            ...
            'max' => 'لطفاً این مقدار را در ۲۵۵ کاراکتر یا کمتر نگه دارید.',
        ],
    ...
    'export' => [
        ...
        'part' => 'پارت',
        'carrier' => 'حمل‌کننده',
        'carrier_english' => 'حمل‌کننده (انگلیسی)',
        'warehouse_date' => 'تاریخ قبض انبار',
        'exit_date' => 'تاریخ خروج',
        'eta' => 'تاریخ ورود (ETA)',
        'etd' => 'تاریخ حرکت (ETD)',
        ...
        'shipped_quantity' => 'مقدار حمل‌شده',
        'status' => 'وضعیت کلی',
        'status_english' => 'وضعیت کلی (انگلیسی)',
        'shipment_status' => 'وضعیت حمل',
        'shipment_status_english' => 'وضعیت حمل (انگلیسی)',
        'operation_status' => 'وضعیت عملیات',
        'operation_status_english' => 'وضعیت عملیات (انگلیسی)',
        'container_status' => 'وضعیت کانتینر',
        'container_status_english' => 'وضعیت کانتینر (انگلیسی)',
        'doc_status' => 'وضعیت اسناد',
        'doc_status_english' => 'وضعیت اسناد (انگلیسی)',
        'documents' => 'اسناد',
        'notes' => 'یادداشت‌ها',
        'creator' => 'ایجادکننده',
